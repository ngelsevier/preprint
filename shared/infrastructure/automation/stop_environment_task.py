...
class StopEnvironmentTask(SandboxEnvironmentTask):
    def __init__(self, service_under_test_directory_path, whole_system):
        ...
        super(StopEnvironmentTask, self).__init__(
            project_layout.system_directory_path() if whole_system else service_under_test_directory_path,
            True,
            'ssrn',
            whole_system,
