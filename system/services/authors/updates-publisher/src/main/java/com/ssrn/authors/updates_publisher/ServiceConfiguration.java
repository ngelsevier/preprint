...
public class ServiceConfiguration extends Configuration {
    ...
    public ServiceConfiguration() {
        ...
        String logFilename = "/var/log/updates-publisher/updates-publisher.log";
        ...
        dataSourceFactory.setUser("publisher");
        dataSourceFactory.setPassword(Boolean.parseBoolean(System.getenv("SIMULATED_ENVIRONMENT")) ? "publisher" : usingKmsDecrypt(System.getenv("ENCRYPTED_DATABASE_PASSWORD")));
