...
public class PageSourceTest {
    ...
    public void shouldRetryRetrievingPageWhenOldPlatformReturnedUnexpectedResponse() {
        ...
        // When
        Page page = pageSource.getPageAt(fakeOldPlatformUrlWithPath("/rest/authors/events"));

        // Then
        assertThat(page.getLinks().getSelf().getHref(), is(equalTo(fakeOldPlatformUrlWithPath("/rest/authors/events"))));
    }
