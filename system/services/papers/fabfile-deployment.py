...
def deploy(
    ...
    configuration = {
        ...
        'terraform': {
            's3_remote_state': {
                ...
                'key': 'services/papers.tfstate'
            },
            'variables': {
                'aws_region': aws_region,
                'contact_details': contact_details,
                'encrypted_emitter_database_user_password': extended_configuration_dictionary[
                    'encryptedEmitterDatabaseUserPassword'
                ],
                ...
                'emitter_memory_reservation': extended_configuration_dictionary[
                    'emitterMemoryReservation'
                ],
                'emitter_max_concurrent_emissions': extended_configuration_dictionary[
                    'emitterMaxConcurrentEmissions'
                ],
                'log_individual_papers': extended_configuration_dictionary[
                    'logIndividualPapers'
                ]
            }
        }
    ...
    if migrate_db:
        migratedb(
            ...
            extended_configuration_dictionary['encryptedEmitterDatabaseUserPassword'],
...
def migratedb(aws_region=None, aws_iam_role_session_credentials=None,
              ...
              encrypted_emitter_database_user_password=None, encrypted_database_migration_user_password=None,
    ...
    migrate_database(
        ...
        encrypted_emitter_database_user_password,
