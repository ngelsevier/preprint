...
def migrate_database(service_directory_path, database_name, aws_region=None,
                     ...
                     encrypted_emitter_database_user_password=None,
    ...
    placeholders = {
        ...
        'emitter_user_password': using_kms_decrypt_or_default(
    ...
    with settings(hide('running', 'warnings'), warn_only=True):
        while True:
            flyway_result = local(
                ...
                '-url=jdbc:postgresql://papers-database.internal-service:5432/{database_name} '
